...
public:
    ...
    QLabel *label;
    QSpinBoxWithSignal *m_spinbox_video_x;
    QSpinBoxWithSignal *m_spinbox_video_y;
    QSpinBoxWithSignal *m_spinbox_video_w;
    QSpinBoxWithSignal *m_spinbox_video_h;
...
namespace Ui {
    class ssrtools: public Input_Widgets {};
} // namespace Ui
